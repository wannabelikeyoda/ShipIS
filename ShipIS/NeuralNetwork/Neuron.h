...
public:
	...
	double GetBias() override { return m_Bias; }
	double GetDelta() override { return m_Delta; }
	double GetOutput() override { return m_Output; }
	void SetOutput(const double& output_val) override { m_Output = output_val; }
	TNeuronConnections Inputs() override { return m_Inputs; }
	TNeurons ForwardNeurons() override { return m_ForwardNeurons; }
	INeuronStrategyPtr Strategy() override { return m_Strategy; }
